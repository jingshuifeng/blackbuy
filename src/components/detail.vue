                            ...
                            <div class="goods-spec">
                                ...
                                <div class="spec-box">
                                    <dl>
                                        ...
                                        <dd>
                                            <div class="stock-box">
                                               <el-input-number v-model="num1" @change="changeHander" :min="1" :max="10" label="描述文字"></el-input-number>
                                            </div>
                                ...
                                <div class="comment-box">
                                    <div id="commentForm" name="commentForm"
                                        ...
                                        <div class="conn-box">
                                            ...
                                            <div class="editor">
                                                <textarea v-model="comment" id="txtContent" name="txtContent" sucmsg=" " datatype="*10-1000" nullmsg="请填写评论内容！" @keyup.enter="open"> 
                                                    </textarea>
                                                <span class="Validform_checktip"></span>
                                            </div>
                                            <div class="subcon">
                                                <el-button :plain="true" @click="open">
                                                <input id="btnSubmit" name="submit" type="submit" value="提交评论"   class="submit"></el-button>
                                                <span class="Validform_checktip"></span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <ul id="commentList" class="list-box">
                                        <p v-if="!message.message" style="margin: 5px 0px 15px 69px; line-height: 42px; text-align: center; border: 1px solid rgb(247, 247, 247);">暂无评论，快来抢沙发吧！</p>
                            ...
                            <div class="sidebar-box">
                                ...
                                <ul class="side-img-list">
                                    <li v-for="(item, index) in hotgoodslist" :key="index">
                                        ...
                                        <div class="txt-box">
                                            <a :href="'http://localhost:8080/index#/detail/' + item.id" class="">{{item.title}}</a>
